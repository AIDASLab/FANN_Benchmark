  ...
  [[0.5]*3, [0.0]*3, [0.5]*3],
    ...
    # for sort_hardness in ["min", "max"]:
        ...
        if dataset_name == "sift1m" or dataset_name == "glove1m" or dataset_name == "gist1m":
            ...
            hardness_path = f"/home/ec2-user/hybrid_search/Benchmark/{dataset_name}/hardness_format"
            mid_format = f"/home/ec2-user/hybrid_search/Benchmark/{dataset_name}/mid_format"
            ...
            data_path=f"/home/ec2-user/hybrid_search/Benchmark/ArXiv/medium/include"
            hardness_path = f"/home/ec2-user/hybrid_search/Benchmark/ArXiv/medium/include/hardness_format"
            mid_format = f"/home/ec2-user/hybrid_search/Benchmark/ArXiv/medium/include/mid_format"
            query_fvecs_path = os.path.join(mid_format, "query_vector.fvecs")
            query_label_path = os.path.join(mid_format, "query_label.txt")
        ...
        if baseline == 1:
            ...
            hardness_path = os.path.join(data_path, "hardness/hardness_v5.1_10000.json")
