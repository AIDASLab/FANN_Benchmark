...
for dataset_name in ["sift1m_NHQ", "sift1m_ACORN", "sift1m_UNG", "sift1m_RWalks"]:
    data_path = f"/home/ec2-user/hybrid_hardness/Benchmark/{dataset_name}"
    ...
    for hardness_type in ["_post", "_corr", "_selec"]:
        ...
        #             with open(f"{data_path}/hardness/hardness_baseline_200.json", "r") as f:
        #                 data = json.load(f)  # list of dicts
        #         else:
        #             with open(f"{data_path}/hardness/hardness_baseline_1000.json", "r") as f:
        #                 data = json.load(f)  # list of dicts
        #     else:
        #         if dataset_name == "arxiv":
        #             with open(f"{data_path}/hardness/hardness_v5.1_200.json", "r") as f:
        #                 data = json.load(f)  # list of dicts
        #         else:
        #             with open(f"{data_path}/hardness/hardness_v5.1_1000.json", "r") as f:
        #                 data = json.load(f)  # list of dicts
        ...
        # else:
        #     # JSON 파일 읽기
        #     with open(f"{data_path}/hardness/hardness_v4.2_10000.json", "r") as f:
        #         data = json.load(f)  # list of dicts
