...
for dataset in dataset_list:
    dataset_path = f"/home/ec2-user/hybrid_hardness/fidelity_experiment/{dataset}"
    ...
    if dataset == "sift_high" or dataset == "sift_low" or dataset == "gist_high" or dataset == "gist_low":
        ...
        # vectors_file = f"{dataset_path}/vectors.npy"
        vectors_file = f"{dataset_path}/mid_format/base_vectors.npy"
        payloads_file = f"{dataset_path}/payloads.jsonl"
        tests_file = f"{dataset_path}/tests.jsonl"
...
with open(os.path.join(".", "Post_Filtering_trade_off_result_generated.pkl"), "wb") as f:
