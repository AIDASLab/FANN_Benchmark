...
for dataset in dataset_list:
    ...
    if dataset == "yfcc":
        ...
        query_label_path = os.path.join(data_path, "yfcc_query_equal.txt")
    else: 
    ...
    query_bin = os.path.join(data_path, f"{dataset}_query_equal.bin")
    gt_file = os.path.join(data_path, "gt.bin")
    gt_counts_file = os.path.join(data_path, "count.txt")
...
import pickle
with open(os.path.join(".", "UNG_trade_off_result_semi.pkl"), "wb") as f:
